...
1. 修复 Codex 官方 5 小时额度在真实重置后，menubar 账号卡片仍停留旧百分比和旧倒计时的问题。
2. 手动刷新时，Codex 非当前账号的卡片也会直接采用最新官方重置结果，不再被旧会话窗口错误覆盖。
3. 同步刷新安装包、更新清单和 GitHub Release 资源，保证新版本下载、覆盖安装和应用内更新提示一致。
